 ...
 */
public class SpinnerGridFragment extends Fragment implements BrowseSupportFragment.MainFragmentAdapterProvider {
    ...
    private BrowseSupportFragment.MainFragmentAdapter mMainFragmentAdapter =
            new BrowseSupportFragment.MainFragmentAdapter(this) {
                ...
                public void setEntranceTransitionState(boolean state) {
                    SpinnerGridFragment.this.setEntranceTransitionState(state);
                }
            };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.spinner_grid_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        LinearLayout spinnerLayout = (LinearLayout) view.findViewById(R.id.spinnerLayout);
